...
function MintNFT({ nfts, setNfts }) {
    ...
    useEffect(() => {
        ...
        const thumbnail = `../assets/thumbnails/${(nfts.length%7) + 1}.jpg`
    ...
    const handleUpload = async (e) => {
        ...
        try {
            ...
            // const newNFT = { nftName, nftDescription, nftPrice, nftImage, nftUrl }
        ...
        <div>
            <div className="mintForm">
                <div class="row justify-content-center">
                    <div class="col-sm-8 col-lg-6 col-xl-4 border border-5 rounded shadow p-3">
                        ...
                        <div>
                            <label htmlFor="nft-file" class="form-label">
                                Upload File (.mp3/.mp4)
                            </label>
